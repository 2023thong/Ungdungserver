  ...
  if(isset($data -> operation)){
      ...
      if($operation == 'thongtinvn'){
  			...
  			if(isset($data -> user1 ) && !empty($data -> user1) && isset($data -> user1 -> manv) 
  				&& isset($data -> user1 -> tennv) && isset($data -> user1 -> sdt) && isset($data -> user1 -> diachi)){
          ...
          $diachi = $user1 ->diachi;
            ...
            echo $fun -> themnhanvien($manv, $tennv, $sdt, $diachi);
    ...
    if(isset($data -> user1) && !empty($data -> user1) &&isset($data -> user1 -> manv)){
      ...
      echo $fun -> getMsgInvalidParam();
        ...
        if(isset($data -> user ) && !empty($data -> user) && isset($data -> user -> name) && isset($data -> user -> password)){

          $user = $data -> user;
          $name = $user -> name;
          $password = $user -> password;

          echo $fun -> loginUser($name, $password);
